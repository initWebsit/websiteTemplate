...
import { getUserInfo, getWebSession, setConfig } from './store/app'
import Routers from './router'
import store from './store'

export default function AppContainer() {
  const [canMount, setCanMount] = useState(false)
  const [, fetchToken] = useGet('/h5user/loginuserprofile')
  const [, fetchUuid] = useGet('/go/ps/h5user/h5UserTokenQuery')
